...
public class ThemeContentActivity extends AppCompatActivity {
    ...
    private ThemeContentActivity.ThemeDetailPagerAdapter pagerAdapter;
    ...
    private void initViews() {
        ...
        pagerAdapter = new ThemeContentActivity.ThemeDetailPagerAdapter(getSupportFragmentManager(),fragments);
